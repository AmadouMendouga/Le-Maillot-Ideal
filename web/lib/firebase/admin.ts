...
function getAdminApp(): App {
  ...
  // stockée comme `null`.
  // Sous le même garde que initializeApp() ci-dessus (pas juste "appelé une
  // fois en haut du module") : le build Next.js réévalue ce module dans
  // plusieurs bundles de routes, et settings() ne tolère pas un second appel
  // sur une instance Firestore déjà utilisée (échec du build du 07/09/2026 —
