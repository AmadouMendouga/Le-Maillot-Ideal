...
export const ICON_NAMES = [
  ...
  "dark-mode", "delete", "edit", "error", "expand", "grid", "hourglass",
  "image", "info", "inventory", "language", "light-mode", "location",
  "lock", "logout", "mail", "menu", "money", "payment", "percent", "person",
  ...
  "storefront", "swap", "tune", "verified", "visibility", "visibility-off",
  "whatsapp", "zoom",
] as const;
